package it.hurts.shatterbyte.reliquified_artifacts.mixin.init;

import artifacts.item.WearableArtifactItem;
import artifacts.registry.ModItems;
import it.hurts.shatterbyte.reliquified_artifacts.items.EternalSteakItem;
import it.hurts.shatterbyte.reliquified_artifacts.items.EverlastingBeefItem;
import it.hurts.shatterbyte.reliquified_artifacts.items.UmbrellaItem;
import it.hurts.shatterbyte.reliquified_artifacts.items.bracelet.OnionRingItem;
import it.hurts.shatterbyte.reliquified_artifacts.items.bracelet.WitheredBraceletItem;
import it.hurts.shatterbyte.reliquified_artifacts.items.charm.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.feet.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.hands.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.hat.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.necklace.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.charm.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.feet.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.hands.*;
import it.hurts.shatterbyte.reliquified_artifacts.items.hat.*;
