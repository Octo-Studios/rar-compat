...
public class SuperstitiousHatItem extends RAWearableRelicItem {
                ...
                .abilities(AbilitiesTemplate.builder()
                        .ability(AbilityTemplate.builder("looting")
                                ...
                                .stat(AbilityStatTemplate.builder("first_kill_window")
                                        ...
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 10.0125D)
                                ...
                                .stat(AbilityStatTemplate.builder("streak_bonus")
                                        ...
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 0.14993D)
                                        .formatValue(value -> (int) MathUtils.round(value * 100D, 0))
                                        .build())
                                ...
                                .stat(AbilityStatTemplate.builder("max_casts")
                                        .initialValue(1D, 5D)
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 49.9925D)
                                        .formatValue(value -> (int) MathUtils.round(value, 0))
                                        .build())
    ...
    public int getLootingLevel(SlotContext slotContext, @Nullable LootContext lootContext, ItemStack stack) {
        ...
        if (ability.getRankModifierData("first_kill").isEnabled()) {
        ...
        if (ability.getRankModifierData("beast_hunter").isEnabled() && mob instanceof Animal)
