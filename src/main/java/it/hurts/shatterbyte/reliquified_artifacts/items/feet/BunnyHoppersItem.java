...
public class BunnyHoppersItem extends RAWearableRelicItem {
                ...
                .abilities(AbilitiesTemplate.builder()
                        .ability(AbilityTemplate.builder("jump")
                                ...
                                .stat(AbilityStatTemplate.builder("duration")
                                        .initialValue(0.5, 1D)
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 5.0005D)
                                        .formatValue(value -> MathUtils.round(value, 1))
                                        .build())
                                .stat(AbilityStatTemplate.builder("repel_radius")
                                        .initialValue(1D, 3D)
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 4.995D)
                                        .formatValue(value -> MathUtils.round(value, 1))
                                        .build())
                                .stat(AbilityStatTemplate.builder("impact_damage_bonus")
                                        .initialValue(0.25D, 0.5D)
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 1.49925D)
    ...
    public void setTime(ItemStack stack, int value) {
        stack.set(RADataComponent.TIME, Math.max(0, value));
    }
    ...
    public void setToggled(ItemStack stack, boolean value) {
        stack.set(RADataComponent.TOGGLED, value);
    }
    ...
    public void setJumpLocked(ItemStack stack, boolean value) {
        stack.set(RADataComponent.BUNNY_HOPPERS_JUMP_LOCKED.get(), value);
    }
    ...
    private void setUsedMaxDuration(ItemStack stack, boolean value) {
        stack.set(RADataComponent.BUNNY_HOPPERS_USED_MAX_DURATION.get(), value);
    }

    private boolean getUsedMaxDuration(ItemStack stack) {
        return stack.getOrDefault(RADataComponent.BUNNY_HOPPERS_USED_MAX_DURATION.get(), false);
    }

    private void setJumpStartY(ItemStack stack, double value) {
        stack.set(RADataComponent.BUNNY_HOPPERS_JUMP_START_Y.get(), value);
    }

    private double getJumpStartY(ItemStack stack) {
        return stack.getOrDefault(RADataComponent.BUNNY_HOPPERS_JUMP_START_Y.get(), 0D);
    }

    private void setJumpPeakY(ItemStack stack, double value) {
        stack.set(RADataComponent.BUNNY_HOPPERS_JUMP_PEAK_Y.get(), value);
    }

    private double getJumpPeakY(ItemStack stack) {
        return stack.getOrDefault(RADataComponent.BUNNY_HOPPERS_JUMP_PEAK_Y.get(), 0D);
    }
