...
public class GoldenHookItem extends RAWearableRelicItem {
    @Override
                ...
                .abilities(AbilitiesTemplate.builder()
                        .ability(AbilityTemplate.builder("hook")
                                ...
                                .stat(AbilityStatTemplate.builder("experience_bonus")
                                        ...
                                        .targetValue(RelicsScalingModels.MULTIPLICATIVE_BASE.get(), 2.49987D)
    ...
    private static void tryAutoPickupExperience(Player player) {
        ...
        for (var stack : EntityUtils.findEquippedCurios(player, ModItems.GOLDEN_HOOK.value())) {
            ...
            if (!ability.canPlayerUse(player) || !ability.getRankModifierData("boat_guard").isEnabled())
                continue;
    ...
    public static class CommonEvents {
        ...
        public static void onLivingIncomingDamageDealing(LivingIncomingDamageEvent event) {
            ...
            for (var stack : EntityUtils.findEquippedCurios(player, ModItems.GOLDEN_HOOK.value())) {
                ...
                if (ability.getRankModifierData("crowd_pull").isEnabled()) {
                ...
                if (ability.getRankModifierData("disarm").isEnabled()) {
