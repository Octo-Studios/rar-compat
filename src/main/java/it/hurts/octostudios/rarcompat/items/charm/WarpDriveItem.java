...
public class WarpDriveItem extends WearableRelicItem {
    ...
    public static class CommonEvents {
        ...
        public static void onRightClickItem(PlayerInteractEvent.RightClickItem event) {
            ...
            var ability = relic.getRelicData(player, relicStack).getAbilitiesData().getAbilityData("warp");
            ...
            if (ability.isRankModifierUnlocked("weightless"))
        ...
        public static void onEnderPearlTeleport(EntityTeleportEvent.EnderPearl event) {
            ...
            if (!ability.isRankModifierUnlocked("disorientation"))
                return;
            ...
            applyBlindnessAndForget(player, event.getTarget(), radius, durationTicks);
        }
    }
}