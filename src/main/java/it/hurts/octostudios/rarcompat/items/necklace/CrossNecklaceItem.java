                ...
                .abilities(AbilitiesData.builder()
                        .ability(AbilityData.builder("invulnerability")
                                ...
                                .research(ResearchData.builder()
                                        .star(0, 4, 6).star(1, 10, 6).star(2, 4, 20).star(3, 10, 19)
                                        .star(4, 19, 15).star(5, 19, 20).star(6, 11, 26).star(7, 19, 6)
                                        .link(0, 2).link(2, 6).link(6, 5).link(5, 4).link(7, 4).link(4, 1).link(1, 3).link(1, 7).link(1, 0)
                                        .build())
                                .build())
                        .build())
