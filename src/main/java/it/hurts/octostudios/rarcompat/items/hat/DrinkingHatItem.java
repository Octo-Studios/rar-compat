                ...
                .abilities(AbilitiesData.builder()
                        .ability(AbilityData.builder("drinking")
                                ...
                                .research(ResearchData.builder()
                                        .star(0, 14, 4).star(1, 19, 9).star(2, 6, 10)
                                        .star(3, 13, 16).star(4, 8, 16).star(5, 4, 25)
                                        .star(6, 12, 26).star(7, 11, 12).star(8, 18, 5)
                                        .link(0, 2).link(1, 3).link(4, 2).link(4, 3).link(4, 5).link(4, 6)
                                        .link(2, 7).link(3, 7).link(1, 8).link(0, 8).link(5, 6)
                                        .build())
                                .build())
